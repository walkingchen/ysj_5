...
export const flagPost = params => axios.post('/post/flag', params)
...
export const importSystemMessageAssign = (params, config) => axios.post('/post/import_system_message_assign', params, config)
export const importDailyPictures = (params, config) => axios.post('/post/photo/import_daily_poll_pool_pics', params, config)
export const importDailyAssign = (params, config) => axios.post('/post/import_daily_poll_assign', params, config)
