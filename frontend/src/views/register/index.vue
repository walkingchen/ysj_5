<template>
  <div class="login-container">
    <el-form ref="register" :model="registerForm" :rules="rules" class="login-form" auto-complete="on" label-position="left">
...
export default {
  data() {
    ...
    const validateCheckPassword = (rule, value, callback) => {
      if (value === '') {
        callback(new Error('Please enter the check password'))
